...
public class RegistryProtocol implements Protocol {
    ...
    public <T> Exporter<T> export(final Invoker<T> originInvoker) throws RpcException {
    	...
    	logger.info("[暴露服务-export invoker]");
        ...
        //registry provider
        System.out.println("注册provide服务-registry provider");
        ...
        System.out.println("dubbo。url注册结束.");
        ...
        logger.info("[保证每次export都返回一个新的exporter实例]");
